...
The touch screen interface and its pinout are covered in the section [Touch Screen](#the-touch-screen-and-how-it-works-1) later. 
...
5. Function `ssd7317_get_stringsize(&Tahoma_12h, "Hello World", &w, &h)` returns the width and height of the string `Hello World` from the font `Tahoma_12h` defined in a header file **Tahoma_12h.h**. I will explain how to create the file in the next section [LCD Image Converter](#lcd-image-converter-1).
...
There is a zip-zap orange underline on `#include "SSD7317.h"` because its file location cannot be resolved yet. We need to let the IDE know where to find the SSD7317 directory. This is the same procedure to set two variables: **Path Variables** and **Build Variables** as that described in [setup](#download-and-build-the-hello-world-project-1) of Hello World. 
...
Import the project **Touchscreen** to your IDE workspace by following the same procedures to import [**HelloWorld**](#download-and-build-the-hello-world-project-1) previously. 
...
| Marker                                                  | Descriptions                                                 |
| ------------------------------------------------------- | ------------------------------------------------------------ |
| <img src="./Images/Number_circle_44x44_1.png" width=30> | Header file for SSD7317. Don't forget to set the **Path Variables** and **Build Variables** with procedures described in the [Hello World](#download-and-build-the-hello-world-project-1) project to use the driver. |
...
| <img src="./Images/Number_circle_44x44_4.png" width=30> | These header files describe the fonts and icons we generated in the last project [LCD Image converter](#lcd-image-converter-1). |
...
Video below shows an out-cell key demo with metal pads soldered to RX1 and RX3
